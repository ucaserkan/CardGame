...
public class TrainingScript : MonoBehaviour {
	...
	private IEnumerator _StartTraining()
	{
		...
		BaseItemScript newUnit = SceneManagerTM.instance.AddItem(_currentTrainingTroop, -1, (int)randomFrontCell.x, (int)randomFrontCell.z, true, true);
		BaseItemScript nearestArmyCamp = SceneManagerTM.instance.GetNearestArmyCamp(newUnit.GetPosition());
