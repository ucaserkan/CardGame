...
public class GroundManager : MonoBehaviour {
	...
	public void UpdateAllNodes(){
		...
		foreach (KeyValuePair<int, BaseItemScript> entry in SceneManagerTM.instance.GetItemInstances()) {
...
//			}
	...
	public BaseItemScript GetItemInPosition(Vector3 position){
        ...
        SceneManagerTM.instance.GetItemInstances ().TryGetValue (itemInstanceId, out item);
		return item;
	}
