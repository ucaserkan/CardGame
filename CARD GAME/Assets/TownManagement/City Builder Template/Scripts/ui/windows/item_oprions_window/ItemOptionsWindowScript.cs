...
public class ItemOptionsWindowScript : WindowScript {
	...
	{
		BaseItemScript selectedItem = SceneManagerTM.instance.selectedItem;
	...
	public void OnClickRemoveButton()
	{
		...
		DataBaseManager.instance.RemoveItem(SceneManagerTM.instance.selectedItem);
        SceneManagerTM.instance.RemoveItem(SceneManagerTM.instance.selectedItem);
	}
